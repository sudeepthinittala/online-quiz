...
const Register =()=>{
    ...
    return (
        <Fragment>
            ...
            <Link to={validateForm()?{ pathname:"/play/instructions/",aboutProps:{text}} : {pathname:"/register"} }   type="submit" value="Send" ><button className="button" onClick={validateForm && sendData}>Submit</button></Link>
            </form>
        </Fragment>
    );
};

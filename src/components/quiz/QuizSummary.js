         ...
         return (
           <Fragment>
            ...
            <div className="container">
                ...
                <span className="stat right"> {this.state.wrongAnswers}</span><br></br>
                <section className="button-container">
                <span><Link className="return-button"to="/online-quiz">Return back</Link></span>
                <span><Link className="play-button" to={{pathname:"/play/quiz" ,aboutProps:this.state.name}}>Play Again</Link></span>
            </section>
